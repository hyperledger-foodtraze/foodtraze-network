...
function createOrg1() {
  ...
  set -x
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost: --caname ca-org1 -M ${PWD}/organizations/peerOrganizations/org1.example.com/peers/peer1.org1.example.com/msp --csr.hosts peer1.org1.example.com --tls.certfiles ${PWD}/organizations/fabric-ca/org1/tls-cert.pem
  { set +x; } 2>/dev/null
...
function createOrg6() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:6054 --caname ca-org6 --tls.certfiles ${PWD}/organizations/fabric-ca/org6/tls-cert.pem
  { set +x; } 2>/dev/null

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-6054-ca-org6.pem
    OrganizationalUnitIdentifier: client
  PeerOUIdentifier:
    Certificate: cacerts/localhost-6054-ca-org6.pem
    OrganizationalUnitIdentifier: peer
  ...
  infoln "Generating the peer0 msp"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:6054 --caname ca-org6 -M ${PWD}/organizations/peerOrganizations/org6.example.com/peers/peer0.org6.example.com/msp --csr.hosts peer0.org6.example.com --tls.certfiles ${PWD}/organizations/fabric-ca/org6/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the peer0-tls certificates"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:6054 --caname ca-org6 -M ${PWD}/organizations/peerOrganizations/org6.example.com/peers/peer0.org6.example.com/tls --enrollment.profile tls --csr.hosts peer0.org6.example.com --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/org6/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the user msp"
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@localhost:6054 --caname ca-org6 -M ${PWD}/organizations/peerOrganizations/org6.example.com/users/User1@org6.example.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/org6/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the org admin msp"
  set -x
  fabric-ca-client enroll -u https://org6admin:org6adminpw@localhost:6054 --caname ca-org6 -M ${PWD}/organizations/peerOrganizations/org6.example.com/users/Admin@org6.example.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/org6/tls-cert.pem
  { set +x; } 2>/dev/null
